...
function (_HandlerLocator) {
  ...
  function NamespaceHandlerLocator(handlersPath) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NamespaceHandlerLocator).call(this));
  ...
  _createClass(NamespaceHandlerLocator, [{
    ...
    value: function getHandlerForCommand(commandName) {
      ...
      var handlerName = "".concat(commandName.replace('Command', 'Handler'), ".js");
